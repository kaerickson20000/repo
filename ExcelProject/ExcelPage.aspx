<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcelPage.aspx.cs" Inherits="ExcelProject.ExcelPage" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Excel Try !! ... </title>
    ...
    <form id="form1" runat="server">  
        <div class="container py-3">  
            <div class="card">  
                ...
                <div class="card-body">  
                    <button style="margin-bottom:10px;" type="button" class="btn btn-primary bg-success" data-toggle="modal" data-target="#myModal">  
                    ...
                    <asp:GridView ID="GridView1" HeaderStyle-CssClass="bg-primary text-white" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered``">  
                        <EmptyDataTemplate>  
